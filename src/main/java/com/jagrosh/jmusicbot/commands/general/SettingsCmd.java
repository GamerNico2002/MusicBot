...
public class SettingsCmd extends Command 
{
    ...
    protected void execute(CommandEvent event) 
    {
        ...
        String content = EMOJI + " **" + FormatUtil.filter(event.getSelfUser().getName()) + "** settings:";
        ...
        event.getChannel().sendMessage(new MessageCreateBuilder().setContent(content).setEmbeds(ebuilder.build()).build()).queue();
    }
